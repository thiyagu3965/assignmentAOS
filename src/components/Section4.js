...
export default function Section4() {
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12 ">
                    ...
                    <form action="#" method="post"  class="contact-form" role="form" data-aos="fade-up">
                        ...
                        <div class="col-lg-3 col-12 sendbtn mx-auto mt-5">
                            <button type="submit" class="form-control msg">Send</button>
                        </div>
                    </form>
                </div>
    ...
    <section class="google-map">
        <iframe src="https://maps.google.com/maps?q=Av.+L%C3%BAcio+Costa,+Rio+de+Janeiro+-+RJ,+Brazil&t=&z=13&ie=UTF8&iwloc=&output=embed" class="map-iframe" width="100%" height="400"  allowfullscreen="" loading="lazy"></iframe>
    </section>
