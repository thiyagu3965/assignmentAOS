...
import img1 from "../Images/people/img1.jpg"
import img2 from "../Images/people/img2.jpg"
import img3 from "../Images/people/img3.jpg"
import img4 from "../Images/people/img4.jpg"
import img5 from "../Images/people/img5.jpg"
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-12 p-0">      
                    <img src={img} class="img-fluid about-image" alt="" />
                </div>
                    ...
                    <section id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src={img1} class="img-fluid team-image" alt="" />
                            ...
                            {/* <div class="carousel-item">
                                <img src={img2} class="img-fluid team-image" alt="" />
                            ...
                            <div class="carousel-item">
                                <img src={img3} class="img-fluid team-image" alt="" />
                            ...
                            <div class="carousel-item">
                                <img src={img4} class="img-fluid team-image" alt="" />
                            ...
                            <div class="carousel-item">
                                <img src={img5} class="img-fluid team-image" alt="" />
                        ...
                        {/* <button class="carousel-control-prev left carousel-control" type="button" data-bs-target="#myCarousel" data-bs-slide="prev">
                              <span class="carousel-control-prev-icon" aria-hidden="true"></span>

                              <span class="visually-hidden">Previous</span>
                        </button>

                        <button class="carousel-control-next right carousel-control" type="button" data-bs-target="#myCarousel" data-bs-slide="next">
